import{i as e}from"./function-planner-DqIZCnrA.js";import"./ui-yMus3xAk.js";import"./yjs-DLZ4IDYl.js";const t={functions:[{key:1,name:"main",io:"indirect"},{key:2,name:"read_list_of_students",desc:"Read all of the names of students from the given file into a list.",params:[],returns:[{type:"list[str]",desc:"the student names from the file"}],io:"none",testable:!1,code:`with open("students.txt") as file:
