import{i as e}from"./function-planner-DycuQynx.js";import"./ui-yMus3xAk.js";import"./yjs-DLZ4IDYl.js";const s={functions:[{key:1,name:"main",io:"indirect",code:`# Get the random word from the list of words
word = select_word()
...
assert hangman.update_guessed_word("str", "str", "p") == "str"`}],calls:[]};window.addEventListener("DOMContentLoaded",()=>{e("planner","hangman",{initialModel:s,allowedTypes:["int","float","str","bool","list"],minFunctions:9,minTestable:2,adminMode:!1,showCodeFor:"^(main|read_words|play_game|update_guessed_word)$",showTestCodeFor:"^update_guessed_word$",functionReadOnly:[{for:"^(main|read_words|play_game|update_guessed_word)$",fields:["name","desc","params","returns","io","testable","code"]},{for:"^update_guessed_word$",fields:["testCode"]}]})});
