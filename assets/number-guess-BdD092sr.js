import{i as e}from"./function-planner-D-oelpAy.js";import"./ui-yMus3xAk.js";import"./yjs-DLZ4IDYl.js";window.addEventListener("DOMContentLoaded",()=>{e("planner","number-guess",{initialModel:{functions:[{key:1,name:"main",io:"indirect",code:`user_name = input("What's your name? ")
...
if diff < 0:
    ...
    return 'Your guess was too high (not even close)!'`,testCode:`# These are correct - do not change these!
...
assert number_guess.get_guess_outcome(2, 1) == 'Your guess was too high.'`},{key:3,name:"play_one_game",desc:`Plays a single number-guessing game with the user (whose name is given as an argument). To play the game, the computer thinks of a number, and then repeatedly:
