import{i as e}from"./function-planner-BjiJ4D_G.js";import"./ui-yMus3xAk.js";import"./yjs-DLZ4IDYl.js";const t={functions:[{key:1,name:"main",io:"indirect"},{key:2,name:"read_list_of_students",desc:"Read all of the names of students from the given file into a list.",params:[],returns:[{type:"list of str",desc:"the student names from the file"}],io:"none",testable:!1,code:`with open("students.txt") as file:
    ...
    try:
        ...
        print("Grade must be a number.")`},{key:4,name:"median",desc:"Calculate the median of the given list of grades.",params:[{name:"list_of_grades",type:"list of int",desc:"the grades to calculate the median of"}],returns:[{type:"float",desc:"the median of the grades"}],io:"none",testable:!0,testCode:`assert grades.median([1, 2, 3]) == 2
